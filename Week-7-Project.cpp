...
int main()
{
	...
	cout << "Welcome to the Receipt Checker 7000!" << endl;
	cout << "Enter the receipt details and we will recommend how to split the tip and total!" << endl << endl;
	...
	cout << "Thank you for using the Receipt Checker 7000!" << endl;
	cout << "Receipt Checker 8000 Release Date : February 16, 2043" << endl;
